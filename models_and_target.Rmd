...
X = train %>% select(-next_gift, -Year) %>% as.matrix()
...
#Make preds on test
predictions <- predict(model_xgb, newdata = test %>% select(-next_gift, -Year) %>% as.matrix())
